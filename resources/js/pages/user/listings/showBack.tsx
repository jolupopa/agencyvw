    ...
    if (!listing) {
        return (
            <AppLayout breadcrumbs={breadcrumbs}>
                <Head title="Cargando..." />
                <div className="p-4">Cargando detalles del anuncio...</div>
            </AppLayout>
        );
    }
                ...
                <div className="relative min-h-[100vh] flex-1 overflow-hidden rounded-xl border border-sidebar-border/70 md:min-h-min dark:border-sidebar-border">
                    ...
                    <div className="bg-white p-6 rounded shadow">
                        ...
                        <div className="mb-6">
                            ...
                            <p><strong>Tipo de Oferta:</strong> {listing.offer_type ? displayLabels[listing.offer_type.name] || listing.offer_type.name : 'No especificado'}</p>
                            <p><strong>Tipo de Propiedad:</strong> {listing.property_type ? displayLabels[listing.property_type.name] || listing.property_type.name : 'No especificado'}</p>
