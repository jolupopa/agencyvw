...
export default function Password() {
   ...
   // Determine the form action route based on the user's guard
    const formActionRoute = auth.guard === 'admin' ? route('admin.password.update') : route('password.update');

    // Determine the breadcrumbs based on the user's guard
    const breadcrumbs: BreadcrumbItem[] = [
        {
            title: auth.guard === 'admin' ? 'Admin Password settings' : 'Password settings',
